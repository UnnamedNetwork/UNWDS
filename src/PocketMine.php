	...
	function server(){
		...
		if($composerGitHash !== null){
			...
			if($currentGitHash !== $composerGitHash){
				...
				critical_error("In UNWDS, to help our developers easily debugging, we disabled the function that force stop the server if Composer dependancies are not matched.");
				critical_error("But you should sync your Composer dependancies with matched version to run the server software correctly");
				critical_error("To re-enable this function, head to src/PocketMine.php, find this message and delete the # symbol below this message.");
				#exit(1);
			}
		}
