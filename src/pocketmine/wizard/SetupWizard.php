...
class SetupWizard{
	public const DEFAULT_NAME = \pocketmine\DISTRO_NAME . " Server";
	...
	public function run() : bool{
		$this->message(\pocketmine\DISTRO_NAME . " set-up wizard");
	...
	private function showLicense() : bool{
		$this->message($this->lang->translateString("welcome_to_pocketmine", [\pocketmine\DISTRO_NAME]));
		echo <<<LICENSE
...
CMNOTES;
	...
	private function endWizard() : void{
		...
		$this->message($this->lang->translateString("pocketmine_will_start", [\pocketmine\DISTRO_NAME]));
