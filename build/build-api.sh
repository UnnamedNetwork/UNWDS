...
DistroVersion=$(php -r 'require "vendor/autoload.php"; echo VersionInfo::DISTRO_VERSION;')
#BuildNumber=$(php -r 'require "vendor/autoload.php"; echo VersionInfo::BUILD;') #skipped this
IsDev=$(php -r 'require "vendor/autoload.php"; echo VersionInfo::IS_DEVELOPMENT_BUILD;')
Branch="${GITHUB_REF##*/}"
GitCommit="${GITHUB_SHA}"
TargetVersion=$(php -r 'require "vendor/autoload.php"; echo ProtocolInfo::MINECRAFT_VERSION;')
Date=$(date +"%s")
if [ "$IsDev" = "0" ]; then
    IsDev="false"
else
