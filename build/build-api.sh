...
#PhpVersion=$(php -r "echo PHP_MAJOR_VERSION.'.'.PHP_MINOR_VERSION;") #this will print PHP 8.0 because our workflow are currently running only on PHP 8.0. When PHP 8.0 are officially supported, we will use this.
PhpVersion="7.4"
